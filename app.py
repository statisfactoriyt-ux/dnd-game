...
- Ты ОБЯЗАН объединять действия ВСЕХ игроков в ОДНО общее повествование.
- Ты НЕ должен писать отдельные сюжеты для каждого игрока — все события происходят одновременно в одном мире.

**ОТВЕТ ДОЛЖЕН БЫТЬ:**
- ОДНИМ ЦЕЛЬНЫМ ТЕКСТОМ (не разбивать на части по игрокам).
- Описывать, как действия всех игроков влияют друг на друга и на мир.
- Заканчиваться вопросом: "Что вы делаете?" (во множественном числе).

**ПРИМЕР ПРАВИЛЬНОГО ОТВЕТА:**
"Ярик и Никита объединяются. Ярик создаёт пиво из воздуха, а Никита использует магию, чтобы защитить его. Вместе они становятся легендой города. Что вы делаете дальше?"

**ПРИМЕР НЕПРАВИЛЬНОГО ОТВЕТА (ЗАПРЕЩЁН):**
"Ярик делает пиво. Никита колдует. Ярик идёт в таверну. Никита идёт в лес."

**ЗАПРЕЩЕНО:**
- Писать ответы по частям (сначала про Ярика, потом про Никиту).
- Игнорировать действия других игроков.
- Создавать отдельные сюжеты для каждого игрока.
"""}],
            "round_number": 1,
            "timer_start": None,
            "timer_duration": 60,
...
ОБЯЗАТЕЛЬНО объедини действия ВСЕХ игроков в ОДНУ общую историю.
НЕ пиши отдельные части для каждого игрока.
...
Опиши результат как ОДНО ЦЕЛОЕ повествование.
Обновляй здоровье в формате: ИМЯ: здоровье = X.
